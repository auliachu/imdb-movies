...
/***/ "./src/scripts/component/search-bar.js":
/*!*********************************************!*\
  !*** ./src/scripts/component/search-bar.js ***!
  \*********************************************/
/***/ (() => {
  ...
  render() {
    this.shadowDOM.innerHTML = `
        ...
        <div class="search-container" id="search-container">
          <input type="text" class="form-control input-keyword" id="searchElement" placeholder="Search Your Favorite Movie">
          <button class="searchButtonElement" id="searchButtonElement" type="submit">Search</button>
        </div>
        `;
...
/* harmony export */   "default": () => (__WEBPACK_DEFAULT_EXPORT__)
/* harmony export */ });
/* harmony import */ var _scripts_component_search_bar_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../scripts/component/search-bar.js */ "./src/scripts/component/search-bar.js");
/* harmony import */ var _scripts_component_search_bar_js__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(_scripts_component_search_bar_js__WEBPACK_IMPORTED_MODULE_0__);
...
function main() {
  ...
  const getMovies = () => {
    ...
    buttonElement.addEventListener("click", function () {
      ...
      console.log(keyword);
      fetch(`http://www.omdbapi.com/?apikey=${key}&s=${keyword}`).then(response => {
...
/* harmony import */ var _scripts_component_search_bar_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./scripts/component/search-bar.js */ "./src/scripts/component/search-bar.js");
/* harmony import */ var _scripts_component_search_bar_js__WEBPACK_IMPORTED_MODULE_3___default = /*#__PURE__*/__webpack_require__.n(_scripts_component_search_bar_js__WEBPACK_IMPORTED_MODULE_3__);
/* harmony import */ var _scripts_main_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./scripts/main.js */ "./src/scripts/main.js");





(0,_scripts_main_js__WEBPACK_IMPORTED_MODULE_4__["default"])();
})();
